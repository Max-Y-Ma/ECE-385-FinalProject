...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Imersiv_NN.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Imersiv_NN
SOPC_NAME := Imersiv_NN
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80112c0
SOPC_SYSID_FLAG += --sidp=0x80112c0
ELF_PATCH_FLAG  += --sidp 0x80112c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1683095388
SOPC_SYSID_FLAG += --timestamp=1683095388
ELF_PATCH_FLAG  += --timestamp 1683095388
