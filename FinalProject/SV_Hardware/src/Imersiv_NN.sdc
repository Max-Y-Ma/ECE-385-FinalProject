...
# VGA CLK / VSync
create_generated_clock -divide_by 2 -source [get_ports MAX10_CLK1_50] [get_nets {Imersiv_NN:Imersiv_SOC_|vga_avl_interface:vga_avl_interface_0|vga_controller:VGA_|clkdiv}]
